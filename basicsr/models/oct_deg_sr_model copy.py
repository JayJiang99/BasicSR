...
class OCTDegSRModel(BaseModel):
    ...
    def optimize_trans_models(self, step, loss_dict):
        ...
        if self.losses.get("sr_pix_trans"):
            ...
            self.set_requires_grad(["network_g"], False)
    ...
    def optimize_sr_models(self, step, loss_dict):
        # Only update net_g
        self.set_requires_grad(["network_g"], True)
        ...
        loss_G.backward()
        self.clip_grad_norm(["network_g"], self.max_grad_norm)
